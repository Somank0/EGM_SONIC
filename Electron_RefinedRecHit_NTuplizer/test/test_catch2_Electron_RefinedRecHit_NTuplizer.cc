...
static constexpr auto s_tag = "[Electron_RefinedRecHit_NTuplizer]";

TEST_CASE("Standard checks of Electron_RefinedRecHit_NTuplizer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("Electron_RefinedRecHit_NTuplizer"
